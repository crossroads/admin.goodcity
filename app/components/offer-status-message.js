...
export default Component.extend({
  ...
  displayCloseOfferAction: computed(
    "offer.{allItemsRejected,state}",
    function() {
  ...
  transportTime: computed(
    "offer.{delivery,state}",
    "offer.delivery.schedule.{dayTime,scheduledAt,slotName}",
    function() {
  ...
  reviewStatusMessage: computed(
    ...
    function() {
      ...
      if (!offer.get("nonEmptyOffer")) {
        ...
        prefix = offer
          .get("i18n")
          .t("review_offer.goods_start_receiving_by", {
        ...
        prefix = offer
          .get("i18n")
          .t("review_offer.goods_received_by", {
        ...
        prefix = offer
          .get("i18n")
          .t("review_offer.offer_closed_by", {
        ...
        prefix = offer
          .get("i18n")
          .t("review_offer.review_started_by", {
